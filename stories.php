...
<!-- Mirrored from demo.artureanec.com/html/helpo/stories.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Feb 2022 21:00:45 GMT -->
	...
	<body>
		<div class="page-wrapper">
			...
			?>
			<main class="main">
				<section class="promo-primary" style="background-color: #098030;">
					<div class="container">
						<div class="row">
							<div class="col-auto">
									...
									<div class="row align-items-center flex-column-reverse flex-lg-row">
										<div class="col-lg-6 col-xl-6">
											<div class="heading heading--primary"><span class="heading__pre-title">01</span>
												<h2 class="heading__title"><span>Water </span> <span>supply</span></h2>
											</div>
											<p>Water being still scarce in the city of Goma, we have created a standpipe to provide access to drinking water in part of the himbi district.</p>
										</div>
										<div class="col-lg-6 col-xl-5 offset-xl-1">
											<div class="img-box"><img class="img--layout" src="img/storie_2-layout.png" alt="img"/>
												<div class="img-box__img"><img class="img--bg" src="img/whater-prj4.jpg" alt="img"/></div>
											</div>
										</div>
									</div>
								</div>
