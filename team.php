...
<!-- Mirrored from demo.artureanec.com/html/helpo/team.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Feb 2022 21:01:28 GMT -->
<head>
		<meta charset="UTF-8"/>
		...
		<div class="page-wrapper">
			...
			<main class="main">
				<section class="promo-primary promo-primary--elements">
					<picture>
						<source srcset="img/alerts.jpg" media="(min-width: 992px)"/><img class="img--bg" src="img/alerts.jpg" alt="img"/>
					</picture>
						...
						<div class="col-sm-6 col-lg-3">
							...
							<nav>
								<ul class="footer-menu">
									...
									<li class="footer-menu__item"><a class="footer-menu__link" href="causes.php">Causes</a></li>
								</ul>
							</nav>
							<!-- footer nav end-->
						</div>
